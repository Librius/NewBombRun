...
public class IconProgressBar : MonoBehaviour
{
    ...
    /// <summary>
    /// Called er frame to move the mask as needed
    /// </summary>
    void UpdateAnimation()
    {
        ...
        for(int i = 0; i < maxIcons; i++)
        {
            ...
            mainImages[i].transform.position = transform.position + new Vector3(totalWidth * (i + 0.5f), 0, 0);
        }
    ...
    GameObject InstantiateBacking(int index)
    {
        ...
        backingObject.transform.parent = transform;
    ...
    /// <param name="index"></param>
    /// <returns></returns>
    GameObject InstantiateMainImage(int index)
    {
        ...
        mainImageObject.transform.parent = mainImageContainer;
